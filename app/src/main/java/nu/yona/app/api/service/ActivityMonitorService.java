...
public class ActivityMonitorService extends Service
{
	...
	private void displayActivityMonitoringNotification()
	{
		...
		PendingIntent pendingIntent = PendingIntent.getActivity(YonaActivity.getActivity(), 0 /* Request code */, intent,
				PendingIntent.FLAG_ONE_SHOT);
		((NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE)).createNotificationChannel(channel);
		Notification notification = new NotificationCompat.Builder(this, CHANNEL_ID)
				.setSmallIcon(R.drawable.ic_launcher)
				.setContentTitle(this.getString(R.string.appname))
				.setContentText(this.getString(R.string.yona_notification_content))
